...
class srcDevDebugProjectContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'project_master_index' => array(array(), array('_controller' => 'App\\Controller\\ProjectMasterController::index'), array(), array(array('text', '/project/master/')), array(), array()),
        'project_master_new' => array(array(), array('_controller' => 'App\\Controller\\ProjectMasterController::new'), array(), array(array('text', '/project/master/new')), array(), array()),
        'project_master_show' => array(array('id'), array('_controller' => 'App\\Controller\\ProjectMasterController::show'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/project/master')), array(), array()),
        'project_master_edit' => array(array('id'), array('_controller' => 'App\\Controller\\ProjectMasterController::edit'), array(), array(array('text', '/edit'), array('variable', '/', '[^/]++', 'id'), array('text', '/project/master')), array(), array()),
        'project_master_delete' => array(array('id'), array('_controller' => 'App\\Controller\\ProjectMasterController::delete'), array(), array(array('variable', '/', '[^/]++', 'id'), array('text', '/project/master')), array(), array()),
