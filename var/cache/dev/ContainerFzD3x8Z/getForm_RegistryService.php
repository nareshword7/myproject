...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ProjectMasterType' => function () {
    return ($this->privates['App\Form\ProjectMasterType'] ?? $this->privates['App\Form\ProjectMasterType'] = new \App\Form\ProjectMasterType());
