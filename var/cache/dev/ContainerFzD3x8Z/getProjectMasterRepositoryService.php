...
// Returns the private 'App\Repository\ProjectMasterRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProjectMasterRepository.php';

return $this->privates['App\Repository\ProjectMasterRepository'] = new \App\Repository\ProjectMasterRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
